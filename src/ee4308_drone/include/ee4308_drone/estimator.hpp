...
namespace ee4308::drone
{
    ...
    private:
        ...
        std::ofstream sonar_file_;
        std::ofstream magnet_file_;
        ...
        int GPSest=0;
        int RzSonarest=0;
        std::deque<Eigen::Vector3d> GPS;
        std::deque<double> SonarHist;
        std::deque<double> Magnet;
        std::deque<double> Xvel;
        std::deque<double> Yvel;
        int Magnest=0;
        double sinlat;
        double sinlon;
        double coslat;
